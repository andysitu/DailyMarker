...
namespace DailyMarker.Controllers
{
    public class UserAccountsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,TableTaskId")] UserAccount userAccount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,TableTaskId")] UserAccount userAccount)
        {
